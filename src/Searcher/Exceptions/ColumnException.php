...
class ColumnException extends \LogicException {
	 ...
	 * @const  COLUMN_DOES_NOT_SUPPORT  has code "0"
	 */
	const COLUMN_DOES_NOT_SUPPORT  		= 	0;

	/**
	 * Code for "not existing column"
	 * @const  COLUMN_DOES_NOT_EXISTS  has code "1"
	 */
	const COLUMN_DOES_NOT_EXISTS		= 	1;

	/**
	 * Code for "non existing order type"
	 * @const  ORDER_TYPES_DOES_NOT_EXISTS  has code "2"
	 */
	const ORDER_TYPES_DOES_NOT_EXISTS 	= 	2;
